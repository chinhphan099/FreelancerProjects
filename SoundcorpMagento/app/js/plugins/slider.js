    ...
    initSlider: function() {
      ...
      switch(this.options.type) {
        case TypeSliders.SINGLE:
          ...
          break;
        case TypeSliders.FADE:
          option = $.extend(this.options.singleSlider, {fade: true});
          break;
        case TypeSliders.CAROUSEL:
          option = this.options.carousel;
          break;
        case TypeSliders.BRANDS:
          option = this.options.brands;
          break;
      ...
      this.handle.on('afterChange.' + pluginName, function() {
        ...
        // Auto play on Paused youtube/video
        if(typeof YT === 'object') {
